      ...
      <div className="bg-white border border-slate-100 p-6 rounded-2xl shadow-soft">
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-500 max-w-lg leading-relaxed">
            The visionary engineer behind MarkFlow - Continuous Assessment Calculator. Connect and explore my portfolio channels below.
          </p>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
        {/* Profile Card (Md: 5/12) */}
        <div className="md:col-span-5">
          ...
          >
            ...
            >
              ...
              <div className="h-24 w-24 rounded-2xl overflow-hidden border-2 border-indigo-50 shadow-soft-sm bg-indigo-50/30 flex items-center justify-center relative group">
                <img
                  src="/profile.jpg"
                  alt="Phaniswar"
                  ...
                  onError={(e) => {
                    ...
                    e.target.parentNode.innerHTML = '<span class="text-calm-indigo text-3xl font-black">P</span>';
                  }}
                />
              </div>
              ...
              <div className="flex items-center gap-1.5 justify-center mt-5">
                <h2 className="text-lg font-black text-slate-800 tracking-tight leading-none">Phaniswar</h2>
                <div className="h-4.5 w-4.5 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center text-calm-indigo shrink-0" title="Verified Developer">
              ...
              <div className="flex flex-wrap gap-1.5 justify-center mt-4">
                <span className="text-[9px] font-black text-indigo-600 bg-indigo-50 border border-indigo-100/50 px-3 py-0.5 rounded-full uppercase tracking-wider">
                  MERN Stack
                </span>
                <span className="text-[9px] font-black text-emerald-600 bg-emerald-50 border border-emerald-100/50 px-3 py-0.5 rounded-full uppercase tracking-wider">
                  Full Stack
                </span>
              </div>
            </Card>
